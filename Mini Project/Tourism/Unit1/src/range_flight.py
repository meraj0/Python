    ...
    try:
        for line in open(file_name).readlines():
            ...
            data=({'place':temp.pop(0),'city':temp.pop(0),'placeType':temp.pop(0),'hotelName':temp.pop(0),\
                   'month':temp.pop(0),'weather':temp.pop(0),'Flight distance':temp.pop(0),'distance':temp.pop(0),'budget':temp.pop(0),\
                'days':temp.pop(0),'hotelStnd':temp.pop(0),'state':temp.pop(0),'Flight distance':temp.pop(0)})
